...
<body>
  ...
  <header>
    <div class="content">
      ...
      <nav class="desktop">
        <ul>
          <li id = main_id><a href="#">Home</a></li>
  ...
  <div class="row">
            ...
            <div class="col-md-8">
                <form action="" method="post">
                    <a class="btn btn-primary" href="admin_rooms.php">Book Room</a>
                    <a class="btn btn-success" href="admin_rooms.php">Check Room Status</a>
                    <a class="btn btn-warning" href="checked_in_details.php">View Users Detail</a>
